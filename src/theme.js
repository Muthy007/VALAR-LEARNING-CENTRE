  ...
  components: {
      ...
      styleOverrides: {
        ...
        containedPrimary: {
          ...
          '&:hover': {
            ...
            boxShadow: '0 8px 25px rgba(16, 27, 51, 0.3)',
          },
        },
        containedSecondary: {
          ...
          '&:hover': {
            ...
            boxShadow: '0 8px 25px rgba(30, 148, 87, 0.4)',
          },
        },
      },
    },
    MuiCard: {
      styleOverrides: {
        root: {
          borderRadius: 20,
          boxShadow: '0px 8px 25px rgba(16, 27, 51, 0.05)',
          transition: 'all 0.35s cubic-bezier(0.4, 0, 0.2, 1)',
          border: '1px solid rgba(16, 27, 51, 0.06)',
          '&:hover': {
            transform: 'translateY(-6px)',
            boxShadow: '0px 16px 36px rgba(16, 27, 51, 0.1)',
          },
        },
      },
    },
